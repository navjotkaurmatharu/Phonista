...
<html lang="en">
<head>
    <title>Sign Up | Phonista.com</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
               <img class="img-thumbnail" src="./img/signuppage.jpg">
            </div>

            <div class="col-sm-5" style="margin-bottom:360px;">

                <h2 style="color:#8000000">SIGN UP</h2>
                    ...
                    <form  action="signup_script.php" method="POST">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" name="submit" class="btn btn-primary" style="background-color:#800000;color:#ffffff">Submit</button>
                        </div>  
                        <div class="col-sm-10">
